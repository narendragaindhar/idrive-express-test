...
RSpec.describe API::V3::OrdersController, type: :controller do
  describe 'POST #create' do
    ...
    context 'with missing data' do
      ...
      it 'rejects missing nested customer object' do
        data = attributes_for(:api_v3_order)
    ...
    context 'with invalid data' do
      it 'rejects invalid data' do
        post :create, params: attributes_for(:api_v3_order, size: -1, destination: { key: 'harblar' })
    ...
    context 'with valid "upload" data' do
      it 'is successful' do
        post :create, params: attributes_for(:api_v3_order_upload)
      ...
      it 'is an "upload" type of order' do
        post :create, params: attributes_for(:api_v3_order_upload)
        response_data = JSON.parse(response.body)
        expect(response_data['order_type']['key']).to eq('upload')
      end
      ...
      it 'reuses existing customers with same username' do
        expect do
          post :create, params: attributes_for(:api_v3_order_upload, username: 'user_name')
          assert_response :created
    ...
    context 'with valid "restore" data' do
      it 'is successful' do
        post :create, params: attributes_for(:api_v3_order_restore)
        assert_response :created
      end
      ...
      it 'is an "restore" type of order' do
        post :create, params: attributes_for(:api_v3_order_restore)
        response_data = JSON.parse(response.body)
        expect(response_data['order_type']['key']).to eq('restore')
      end
      ...
      it 'reuses existing customers with same username' do
        expect do
          post :create, params: attributes_for(:api_v3_order_restore, username: 'user_name')
          assert_response :created
    ...
    context 'with valid "idrive_one" data' do
      it 'is successful' do
        post :create, params: attributes_for(:api_v3_order_idrive_one)
        assert_response :created
      end
      ...
      it 'is an "idrive_one" type of order' do
        post :create, params: attributes_for(:api_v3_order_idrive_one)
        response_data = JSON.parse(response.body)
        expect(response_data['order_type']['key']).to eq('idrive_one')
      end
      ...
      it 'reuses existing customers with same username' do
        expect do
          post :create, params: attributes_for(:api_v3_order_idrive_one, username: 'user_name')
          assert_response :created
