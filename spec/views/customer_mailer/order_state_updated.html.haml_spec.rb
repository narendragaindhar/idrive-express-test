...
RSpec.describe 'customer_mailer/order_state_updated.html.haml', type: :view do
  helper MailHelper

  let(:customer) { create(:customer, name: 'José Pedro') }
  ...
  it 'greets the customer by name' do
    expect(rendered).to match('Hello José Pedro,')
  end
